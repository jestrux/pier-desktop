    ...
    return function ({ addComponents }) {
        addComponents({
            ...
            ".table": {
                ...
                "td,th": {
                    padding: optionsWithPropertyExists(options, "cellPadding")
                        ? options.cellPadding
                        : ".75rem",
                    verticalAlign: optionsWithPropertyExists(
                        options,
                        "verticalAlign"
                    )
                        ? options.verticalAlign
                        : "top",
                    // borderTop: optionsWithPropertyExists(
                    //     options,
                    //     "tableBorderColor"
                    // )
                ...
                td: {
                    borderTop:
                        optionsWithPropertyExists(options, "tableBodyBorder") &&
                        options.tableBodyBorder == false
                            ? 0
                            : optionsWithPropertyExists(
                                  options,
                                  "tableBorderColor"
                              )
                            ? "1px solid " + options.tableBorderColor
                ...
                "thead th": {
                    ...
                    // borderBottom: optionsWithPropertyExists(
                    //     options,
                    //     "tableBorderColor"
                    // )
                    //     ? "1px solid " + options.tableBorderColor
            ...
            ".table-bordered": {
                border: optionsWithPropertyExists(options, "tableBorderColor")
                    ...
                    : "1px solid #dee2e6",
                "td,th": {
                    border: optionsWithPropertyExists(
                        options,
                        "tableBorderColor"
                    )
                        ? "1px solid " + options.tableBorderColor
            ...
            ".table-striped tbody tr:nth-of-type(odd)": {
                backgroundColor: optionsWithPropertyExists(
                    options,
                    "tableStripedBackgroundColor"
                )
            ...
            ".table .thead-light th": {
                ...
                borderColor: optionsWithPropertyExists(
                    options,
                    "tableBorderColor"
                )
