...
import { ListPickerComponent } from "../SpotlightComponents/ListPicker";
...
export default function ColorPickerPage({ page }) {
	const { ...props } = page || {};
	const [color, setColor] = useState(props.value);
	const isGradient =
		props.value && props.value?.toString().indexOf("linear-gradient") != -1;
	const { value: colorType } = useSpotlightPageActions(
