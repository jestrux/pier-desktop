...
export default function WebsiteNavbar() {
	...
	const roundedCorners = app.settings.roundedCorners;
						...
						<div className="flex items-center gap-2">
							{buttons.map((button, index) => {
								...
								switch (button.style) {
									case "Filled":
										styling = !useAppColor
											? "bg-[--text-color] text-[--inverted-text-color] "
								...
								return (
									<a
										key={index}
										href="#"
										className={`${styling} group min-w-[80px] flex items-center justify-center h-9 px-4 text-sm font-semibold text-center focus:outline-none`}
									>
